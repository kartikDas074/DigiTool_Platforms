...
const Banner = () => {
    return (
        <div className='w-full max-w-[95vw] mx-auto md:max-w-[85vw]  justify-center items-center py-15 lg:py-20 gap-[20px] grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2'>
            <div>
                ...
                <div className='flex flex-col md:flex-row gap-[16px]'>
                    ...
                    <button className='btn border bg-linear-to-r from-[#4F39F6] to-[#9514FA] bg-clip-text text-transparent border-[#4F39F6] rounded-[20px]'> <img src={demo} alt="" />Watch Demo</button>
                </div>
            </div>
            <div>
                <img src={banner} alt="" />
